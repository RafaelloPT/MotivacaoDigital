...
function typeWriter(text, element, speed = 100) {
  ...
  function handleEnter(event) {
    if (event.key === 'Enter') {
      ...
      setTimeout(() => {
        ...
        document.getElementById('confirm-btn').addEventListener('click', handleConfirmSelection);
      }, 500);
    }
  }
  ...
  function checkSelectedCategories() {
    ...
    // Habilita o botão de confirmar apenas se houver categorias selecionadas
